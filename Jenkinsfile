pipeline {  
  ...
  stages {
    ...
    stage('Analysis') {
      steps {
		sh "dotnet /sonar-scanner/SonarScanner.MSBuild.dll begin /k:MyProject /d:sonar.host.url='http://3.6.93.103:9000' /d:sonar.login='c87723110deab90be1520f7554dd3b85b7b82427'"
		sh "dotnet build"
