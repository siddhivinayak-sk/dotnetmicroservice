pipeline {  
  ...
  stages {
    ...
    stage('Analysis') {
      steps {
		sh "dotnet /sonar-scanner/SonarScanner.MSBuild.dll begin /k:dotnet-customer-ms /d:sonar.host.url='http://3.110.178.45:9000' /d:sonar.login='c87723110deab90be1520f7554dd3b85b7b82427'"
		sh "dotnet build"
